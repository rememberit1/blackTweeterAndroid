...
package com.blacktweeter.android.twitter.activities.drawer_activities;
...
import com.blacktweeter.android.twitter.activities.search.SearchPager;
import com.blacktweeter.android.twitter.adapters.MainDrawerArrayAdapter;
...
import com.blacktweeter.android.twitter.listeners.MainDrawerClickListener;
import com.blacktweeter.android.twitter.settings.AppSettings;
import com.blacktweeter.android.twitter.settings.SettingsActivity;
import com.blacktweeter.android.twitter.utils.XmlFaqUtils;
import com.blacktweeter.android.twitter.views.ActionBarDrawerToggle;
import com.blacktweeter.android.twitter.views.HoloTextView;
import com.blacktweeter.android.twitter.views.NotificationDrawerLayout;
import com.blacktweeter.android.twitter.R;
import com.blacktweeter.android.twitter.adapters.InteractionsCursorAdapter;
import com.blacktweeter.android.twitter.adapters.TimelinePagerAdapter;
import com.blacktweeter.android.twitter.data.App;
import com.blacktweeter.android.twitter.data.sq_lite.*;
import com.blacktweeter.android.twitter.listeners.InteractionClickListener;
...
import com.blacktweeter.android.twitter.activities.setup.LoginActivity;
...
public abstract class DrawerActivity extends Activity {
    ...
    public void setUpDrawer(int number, final String actName) {
        ...
        TypedArray aVariable = context.getTheme().obtainStyledAttributes(new int[]{R.attr.drawerIcon});
        int resource = aVariable.getResourceId(0, 0);
        aVariable.recycle();

        aVariable = context.getTheme().obtainStyledAttributes(new int[] {R.attr.read_button});
        openMailResource = aVariable.getResourceId(0,0);
        aVariable.recycle();

        aVariable = context.getTheme().obtainStyledAttributes(new int[] {R.attr.unread_button});
        closedMailResource = aVariable.getResourceId(0,0);
        aVariable.recycle();
