...
package com.blacktweeter.android.twitter.settings.configure_pages;
...
public class ConfigurationPagerAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        return context.getResources().getString(com.blacktweeter.android.twitter.R.string.page).replace("%s", (position + 1) + "");
    }
}
