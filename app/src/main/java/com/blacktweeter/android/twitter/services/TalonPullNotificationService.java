...
import com.blacktweeter.android.twitter.activities.compose.WidgetCompose;
    ...
    public void onCreate() {
        ...
        mBuilder =
                new NotificationCompat.Builder(this)
                        ...
                        .setContentTitle(getResources().getString(R.string.blacktweeter_pull) + (multAcc ? " - @" + settings.myScreenName : ""))
                        .setContentText(text)
                        .setOngoing(true)
