...
import com.blacktweeter.android.twitter.data.ScheduledTweet;
...
import com.blacktweeter.android.twitter.services.CatchupPull;
import com.blacktweeter.android.twitter.services.DirectMessageRefreshService;
import com.blacktweeter.android.twitter.services.MentionsRefreshService;
import com.blacktweeter.android.twitter.services.SendScheduledTweet;
import com.blacktweeter.android.twitter.services.TimelineRefreshService;
import com.blacktweeter.android.twitter.services.TrimDataService;
import com.blacktweeter.android.twitter.settings.AppSettings;
import com.blacktweeter.android.twitter.services.*;
import com.blacktweeter.android.twitter.activities.main_fragments.other_fragments.MentionsFragment;
...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (settings.timelineRefresh != 0) { // user only wants manual
            ...
            PendingIntent pendingIntent = PendingIntent.getService(context, HomeFragment.HOME_REFRESH_ID, new Intent(context, TimelineRefreshService.class), 0); //benedit
        ...
        if (settings.mentionsRefresh != 0) {
            ...
            PendingIntent pendingIntent = PendingIntent.getService(context, MentionsFragment.MENTIONS_REFRESH_ID, new Intent(context, MentionsRefreshService.class), 0);//benedit
...
//            am.setRepeating(AlarmManager.RTC_WAKEUP, alarm, settings.activityRefresh, pendingIntent);
        ...
        if (settings.pushNotifications) {
           // context.startService(new Intent(context, CatchupPull.class));//benedit
        }
