...
import com.blacktweeter.android.twitter.adapters.DirectMessageListArrayAdapter;
...
public class DMFragment extends MainFragment {
    ...
    class GetCursorAdapter extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            ...
            ArrayList<com.blacktweeter.android.twitter.data.DirectMessage> messageList = new ArrayList<com.blacktweeter.android.twitter.data.DirectMessage>();
                ...
                if (cursor.moveToLast()) {
                    do {
                        ...
                        if (!names.contains(screenname) && !screenname.equals(DrawerActivity.settings.myScreenName)) {
                            ...
                            messageList.add(new com.blacktweeter.android.twitter.data.DirectMessage(name, screenname, message, profilePic));
                            ...
                            messageList.add(new com.blacktweeter.android.twitter.data.DirectMessage(name, otherName, message, profilePic));
                        }
