...
public class MainActivityPopup extends MainActivity {
    ...
    public void setUpTheme() {
        ...
        DrawerActivity.translucent = false;

        Utils.setUpNotifTheme(context, DrawerActivity.settings);

        if (DrawerActivity.settings.addonTheme) {
            getWindow().setBackgroundDrawable(new ColorDrawable(DrawerActivity.settings.backgroundColor));
        }
    }
