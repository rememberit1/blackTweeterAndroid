...
import com.blacktweeter.android.twitter.data.sq_lite.HomeContentProvider;
    ...
    public void onHandleIntent(Intent intent) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(com.blacktweeter.android.twitter.R.drawable.ic_stat_icon)
                        .setTicker(getResources().getString(com.blacktweeter.android.twitter.R.string.refreshing) + "...")
                        .setContentTitle(getResources().getString(com.blacktweeter.android.twitter.R.string.app_name))
                        .setContentText(getResources().getString(com.blacktweeter.android.twitter.R.string.refreshing_widget) + "...")
                        .setProgress(100, 100, true)
                        .setLargeIcon(BitmapFactory.decodeResource(this.getResources(), com.blacktweeter.android.twitter.R.drawable.drawer_sync_dark));
