...
package com.blacktweeter.android.twitter.activities.drawer_activities.discover.people;
...
import com.blacktweeter.android.twitter.adapters.CategoriesArrayAdapter;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        layout = inflater.inflate(com.blacktweeter.android.twitter.R.layout.trends_list_view, null);
                ...
                try {
                    ...
                    ((Activity)context).runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LinearLayout spinner = (LinearLayout) layout.findViewById(com.blacktweeter.android.twitter.R.id.list_progress);
                    ...
                    ((Activity)context).runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(context, getResources().getString(com.blacktweeter.android.twitter.R.string.no_location), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
