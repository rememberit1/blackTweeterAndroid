...
import com.blacktweeter.android.twitter.utils.ExpansionAnimation;
import com.blacktweeter.android.twitter.R;
import com.blacktweeter.android.twitter.adapters.AutoCompleteHashtagAdapter;
import com.blacktweeter.android.twitter.adapters.AutoCompletePeopleAdapter;
...
import com.blacktweeter.android.twitter.services.SendTweet;
import com.blacktweeter.android.twitter.activities.compose.ComposeActivity;
import com.blacktweeter.android.twitter.activities.compose.ComposeSecAccActivity;
import com.blacktweeter.android.twitter.activities.profile_viewer.ProfilePager;
import com.blacktweeter.android.twitter.activities.tweet_viewer.users_popup.ViewUsersPopup;
import com.blacktweeter.android.twitter.views.EmojiKeyboard;
import com.blacktweeter.android.twitter.activities.photo_viewer.PhotoViewerActivity;
import com.blacktweeter.android.twitter.utils.QustomDialogBuilder;
...
import com.blacktweeter.android.twitter.utils.api_helper.TwitterMultipleImageHelper;
...
public class TweetFragment extends Fragment {
    ...
    private Runnable getCount = new Runnable() {
        ...
        public void run() {
            ...
            if (!text.contains("http")) { // no links, normal tweet
                try {
                    charRemaining.setText(280 - reply.getText().length() - (attachedUri.equals("") ? 0 : 23) + "");
                } catch (Exception e) {
    ...
    public void setUIElements(final View layout) {
        ...
        if (charRemaining != null) {
            charRemaining.setText(280 - reply.getText().length() + "");
        }
